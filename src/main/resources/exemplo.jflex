...
onelinecomment 			= (\/\/)((!(\/\n))*)
nlinescomment 			= (\/*)((!\*\/)*)
comment 				= {onelinecomment}|{nlinescomment}
...
{identifier}			{System.out.println("identificador");}
{integerlit}			{System.out.println("Literais inteiros");}
{digit}					{System.out.println("Inteiro");}
